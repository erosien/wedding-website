...
const Itinerary = () => {
  return (
    ...
    className='flex flex-row justify-center mx-auto bg-cover bg-fixed font-serif'>  
        <div className="bg-stone-200 container mt-5 mb-5 place-items-center p-5 w-100 border-double border-4 border-stone-300 rounded-lg">
            <h1 className="p-8 justify-center text-6xl text-center font-bold">Itinerary</h1>
            <div className="grid grid-cols-2 gap-6 w-2/3 mx-auto bg-stone-300 border-2 border-black rounded-lg p-5 mb-5">
